...
void TPM1_PTE20_config_basica () {
	...
	/*
	 * Configurar PTE20 em TPM1_CH0
	 */
	PORTE_PCR20 |= PORT_PCR_MUX(0x3);
}

void TPM2_PTE22_config_basica() {
	
	SIM_SCGC6 |= SIM_SCGC6_TPM2_MASK;

	SIM_SCGC5 |= SIM_SCGC5_PORTE_MASK; //habilita sinais de relogio
	
	PORTE_PCR22 |= (PORT_PCR_ISF_MASK |	//TPM1_CH2
					PORT_PCR_MUX(0x3) |
