...
int main(void)
{
	...
	LPTMR_config_especifica (0b00, 0b01, 250);  // so temos LPO (0b01) disponivel
...
//	LPTMR0_habilitaNVICIRQ(0);						//!!! se nao eh necessario
													// tratamento especifico do evento
													// nao precisa habilitar IRQ28
